  ...
  <main>
    <section id="home">
      ...
      <div class="auth-buttons">
        <button class="register-button" onclick="window.location.href = 'view/html/LoginRegister/register.php';">Register</button>
        <button class="login-button" onclick="window.location.href = 'view/html/LoginRegister/login.php';">Login</button>
